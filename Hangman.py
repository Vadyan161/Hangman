...
def play(word):
    ...
    while True:
        w = input('Введите предполагаемое слово или букву:').lower()

        if not w.isalpha():
            print("Вы ввели неккоректный символ!")
            continue
        else:
            if len(w) > 1:
                if w == word:
                    ...
                    if w in guessed_words:
                        print("Вы уже вводили это слово!")
                        print(*result)
                        continue
                    else:
                        print("Введенное слово не верно!")
                ...
                if w in word:
                    ...
                    if w in guessed_letters:
                        ...
                        tries -= 1
                        if tries != 0:
                            print('Такой буквы в загаданном слове нет!', 'Оставшееся количество попыток {}'.format(tries),
                                  '', sep='\n')
                            ...
                            print("Вы проиграли!")
                            print("Загаданное слово было:", word.upper())
                            break
...
while flag:
    ...
    n = input("Хотите сыграть еще?")
    if n != 'да' and not 'Да':
        print('Спасибо что играли с нами, приходите еще!')
        flag = False
    else:
        continue
